...
class TestPlugin(unittest.TestCase):
    ...
    @patch("libnetwork.docker_plugin.client.profile_exists", autospec=True, return_value=False)
    @patch("libnetwork.docker_plugin.client.create_profile", autospec=True)
    ...
    @patch("libnetwork.docker_plugin.client.profile_exists", autospec=True, return_value=True)
    @patch("libnetwork.docker_plugin.client.create_profile", autospec=True)
    ...
    @patch("libnetwork.docker_plugin.client.remove_profile", autospec=True)
    ...
    @patch("libnetwork.docker_plugin.client.read_cnm_endpoint", autospec=True)
    @patch("libnetwork.docker_plugin.create_veth", autospec=True)
    @patch("libnetwork.docker_plugin.client.set_endpoint", autospec=True)
  ...
  "StaticRoutes": [
    ...
    @patch("libnetwork.docker_plugin.client.read_cnm_endpoint", autospec=True)
    @patch("libnetwork.docker_plugin.create_veth", autospec=True)
    @patch("libnetwork.docker_plugin.remove_veth", autospec=True)
    @patch("libnetwork.docker_plugin.client.set_endpoint", autospec=True)
    ...
    @patch("libnetwork.docker_plugin.create_veth", autospec=True)
    @patch("libnetwork.docker_plugin.remove_veth", autospec=True)
    @patch("libnetwork.docker_plugin.client.set_endpoint", autospec=True, side_effect=DataStoreError)
    ...
    @patch("libnetwork.docker_plugin.remove_veth", autospec=True)
    @patch("libnetwork.docker_plugin.client.get_endpoint", autospec=True)
    @patch("libnetwork.docker_plugin.client.remove_endpoint", autospec=True)
    ...
    @patch("libnetwork.docker_plugin.backout_ip_assignments", autospec=True)
    @patch("libnetwork.docker_plugin.client.read_cnm_endpoint", autospec=True)
    @patch("libnetwork.docker_plugin.client.delete_cnm_endpoint", autospec=True)
    ...
    @patch("libnetwork.docker_plugin.client.cnm_endpoint_exists", autospec=True, return_value=True)
    @patch("libnetwork.docker_plugin.client.write_cnm_endpoint", autospec=True)
